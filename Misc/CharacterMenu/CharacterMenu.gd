...
func _physics_process(_delta):
	...
	if Input.is_action_just_pressed("CharacterMenu") and PlayerGlobal.charactermenu == false and $"../PauseMenu".visible == false and PlayerGlobal.alchemy == false and PlayerGlobal.in_dialogue == false:
		$Tree/TreeAnim.play("Active")
		get_tree().paused = true
		PlayerGlobal.charactermenu = true
		...
		if PlayerGlobal.charactermenu == true:
			if $Tree/SkillTree.ChoseSkill == false:
				get_tree().paused = false
				$Tree/TreeAnim.play("Inactive")
				PlayerGlobal.charactermenu = false
				Input.set_mouse_mode(Input.MOUSE_MODE_HIDDEN)



			if PlayerGlobal.inventory == true:
				$Tree/Inventory/Anim.play("Inactive")
				PlayerGlobal.inventory = false

			elif PlayerGlobal.skillstree == true:
				if $Tree/SkillTree.ChoseSkill == false:
					$Tree/SkillTree/SkillTreeAnim.play("Deactivate")
					PlayerGlobal.skillstree = false
...
func _on_Map_pressed():
	...
	if PlayerGlobal.skillstree == true:
		$Tree/SkillTree/SkillTreeAnim.play("Deactivate")
		PlayerGlobal.skillstree = false
...
func _on_Inventory_pressed():
	...
	if PlayerGlobal.inventory == false and !$Tree/Inventory/Anim.current_animation == "Inactive":
		$Tree/InventoryCont/Inventory/ButtonAnim.play("Pressed")
		$Tree/Inventory/Anim.play("Active")
		PlayerGlobal.inventory = true

	elif PlayerGlobal.inventory == true and !$Tree/Inventory/Anim.current_animation == "Active":
		$Tree/InventoryCont/Inventory/ButtonAnim.play("Pressed")
		$Tree/Inventory/Anim.play("Inactive")
		PlayerGlobal.inventory = false
...
func _on_SkillTree_pressed():
	...
	if PlayerGlobal.skillstree == false and !$Tree/SkillTree/SkillTreeAnim.current_animation == "Deactivate":
		PlayerGlobal.skillstree = true
		$Tree/SkillTreeCont/SkillTree/ButtonAnim.play("Pressed")
		$Tree/SkillTree/SkillTreeAnim.play("Active")

	elif PlayerGlobal.skillstree == true and !$Tree/SkillTree/SkillTreeAnim.current_animation == "Active":
		PlayerGlobal.skillstree = false
		$Tree/SkillTreeCont/SkillTree/ButtonAnim.play("Pressed")
		$Tree/SkillTree/SkillTreeAnim.play("Deactivate")
...
func _shortcuts():
	if Input.is_action_just_pressed("Inventory") and PlayerGlobal.charactermenu == false and $"../PauseMenu".visible == false and PlayerGlobal.alchemy == false and PlayerGlobal.in_dialogue == false:
		$Tree/TreeAnim.play("Active")
		get_tree().paused = true
		PlayerGlobal.charactermenu = true
		Input.set_mouse_mode(Input.MOUSE_MODE_VISIBLE)

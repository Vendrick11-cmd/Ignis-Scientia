...
export var max_base_damage = 1 setget set_max_base_damage
var base_damage = max_base_damage setget set_base_damage
onready var initial_base_damage = 1.00

signal base_damage_changed(value)
signal max_base_damage_changed(value)
...
func set_max_base_damage(value):
	max_base_damage = value
	self.base_damage = min(base_damage, max_base_damage *64)
	emit_signal("max_base_damage_changed", value)

func set_base_damage(value):
	base_damage = value
	emit_signal("base_damage_changed", base_damage)
...
func _ready():
	...
	self.base_damage = max_base_damage

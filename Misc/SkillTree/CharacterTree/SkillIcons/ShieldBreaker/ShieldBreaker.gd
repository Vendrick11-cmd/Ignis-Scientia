...
func _on_SkillButton_mouse_entered():
	...
	if PlayerGlobal.ShieldBreaker == true and PlayerGlobal.active_skill == false:
		$SkillButton/Skill/AnimationPlayer.play("ActiveHover")
		
func _on_SkillButton_mouse_exited():
	if !$SkillButton/Skill/AnimationPlayer.current_animation == "Click" and PlayerGlobal.ShieldBreaker == false and $Hover/YesNo/Activate.visible == false and PlayerGlobal.active_skill == false:
...
func _on_SkillButton_pressed():
	if PlayerGlobal.Rage == true:
		...
		if PlayerGlobal.skill_selector == 0 and PlayerGlobal.ShieldBreaker == false:
...
func _on_YesButton_pressed():
	...
	PlayerGlobal.ShieldBreaker = true

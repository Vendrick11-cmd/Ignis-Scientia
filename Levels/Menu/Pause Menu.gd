...
func _pause() :
	if Input.is_action_just_pressed("Pause") and get_tree().paused == false and PlayerGlobal.skillstree == false and PlayerGlobal.charactermenu == false and PlayerGlobal.inventory == false and $"../CharacterMenu".visible == false and $"../Tutorials".visible == false:
	...
	elif Input.is_action_just_pressed("Pause") and get_tree().paused == true and PlayerGlobal.skillstree == false and PlayerGlobal.charactermenu == false and PlayerGlobal.inventory == false:
		_reset()

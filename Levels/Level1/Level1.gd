...
func _physics_process(delta):
	...
	if $Misc/Illusion/PortalCast.is_colliding():
		...
		get_tree().change_scene_to(changelevel)
...
func _dialogues():
	...
	if $Dialogues/GraveRandom.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_dialogue == false:
	...
	if $Dialogues/GraveGarrick.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_dialogue == false:
		var dialogue_resource = preload("res://Misc/Dialogues/Level1/Graves.tres")
		DialogueManager.show_example_dialogue_balloon( "GraveGarrick", dialogue_resource)

	if $Dialogues/GraveHemwick.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_dialogue == false:
		var dialogue_resource = preload("res://Misc/Dialogues/Level1/Graves.tres")
		DialogueManager.show_example_dialogue_balloon( "GraveHemwick", dialogue_resource)

	if $Dialogues/GraveRandom2.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_dialogue == false:
		var dialogue_resource = preload("res://Misc/Dialogues/Level1/Graves.tres")
		DialogueManager.show_example_dialogue_balloon( "GraveRandom2", dialogue_resource)

	if $Dialogues/GraveRandom3.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_dialogue == false:
		var dialogue_resource = preload("res://Misc/Dialogues/Level1/Graves.tres")
		DialogueManager.show_example_dialogue_balloon( "GraveRandom3", dialogue_resource)

	if $Dialogues/DoesNotOpenFrom.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_dialogue == false:
...
func _tutorials():
	if $TutorialsRays/BasicMovementTutorial.is_colliding() and PlayerGlobal.movetut == false:
		...
		PlayerGlobal.movetut = true
		get_tree().paused = true

	elif $TutorialsRays/InteractTutorial.is_colliding() and PlayerGlobal.interacttut == false:
		$Tutorials.visible = true
		$Tutorials/Interact.visible = true
		$Tutorials/Interact/AnimationPlayer.play("Start")
		$TutorialsRays/InteractTutorial.enabled = false
		$Hemwick/GUI.visible = false
		PlayerGlobal.interacttut = true
		get_tree().paused = true

	elif $TutorialsRays/WallJumpTutorial.is_colliding() and PlayerGlobal.walljumptut == false:
		$Tutorials.visible = true

...
func _chests():
	...
	if $Background2/ItemChest2/InteractRay.is_colliding() and Input.is_action_just_pressed("Interact"):
		PlayerGlobal.PickUp = true
		PlayerGlobal.Name = "100x Gold"
		IAdd.start()
		PlayerGlobal.coins += 100

		PlayerGlobal.Name = "Regeneration Potion Recipe"
		IAdd.start()
	...
	if $Background2/ItemChest3/InteractRay.is_colliding() and Input.is_action_just_pressed("Interact"):
		...
		PlayerGlobal.Name = "Hunting Instinct Tonic Recipe"
		IAdd.start()
	...
	if $Background2/ItemChest4/InteractRay.is_colliding() and Input.is_action_just_pressed("Interact"):
		PlayerGlobal.PickUp = true
		PlayerGlobal.Name = "Elixir of Undying Recipe"
		IAdd.start()
	...
	if $Background2/ItemChest5/InteractRay.is_colliding() and Input.is_action_just_pressed("Interact"):
		PlayerGlobal.PickUp = true
		PlayerGlobal.Name = "Stamina Potion Recipe"
		IAdd.start()
		InventoryLoad.recipepotionstamina = true


func _tutorials():
	if $TutorialsRays/DodgeDashTutorial.is_colliding() and PlayerGlobal.dodgetut == false:
		...
		PlayerGlobal.dodgetut = true
		get_tree().paused = true

	elif $TutorialsRays/SlamAttackTutorial.is_colliding() and PlayerGlobal.slamtut == false:
		$Tutorials.visible = true
		...
		$Hemwick/GUI.visible = false
		PlayerGlobal.slamtut = true
		get_tree().paused = true

	elif $TutorialsRays/GardeningTutorial.is_colliding() and PlayerGlobal.gardtut == false:
		$Tutorials.visible = true
		...
		$Hemwick/GUI.visible = false
		PlayerGlobal.gardtut = true
		get_tree().paused = true

	elif $TutorialsRays/AlchemyTutorial.is_colliding() and PlayerGlobal.alchemytut == false:
		$Tutorials.visible = true
		$Tutorials/Alchemy.visible = true
		$Tutorials/Alchemy/AnimationPlayer.play("Start")
		$TutorialsRays/AlchemyTutorial.enabled = false
		$Hemwick/GUI.visible = false
		PlayerGlobal.alchemytut = true
		get_tree().paused = true

	elif $TutorialsRays/SkillPointsTutorial.is_colliding() and PlayerGlobal.skilltut == false:
		$Tutorials.visible = true
...
func _spawnpoints():
	...
	if $SpawnPoints/Spawn.is_colliding():
		PlayerGlobal.SpawnPosX = 981.393
		PlayerGlobal.SpawnPosY = 608.986
		$Sounds/BirdChirp.stop()
		$Sounds/Cricket.stop()
		$Sounds/NightFrogs.stop()
		$Sounds/Cricket2.stop()
	...
	if $SpawnPoints/Spawn2.is_colliding():
		PlayerGlobal.SpawnPosX = 14883.409
		PlayerGlobal.SpawnPosY = 70.845
		$Sounds/BirdChirp.stop()
		$Sounds/Cricket.stop()
		$Sounds/NightFrogs.stop()
		$Sounds/Cricket2.stop()
	...
	if $SpawnPoints/Spawn3.is_colliding():
		PlayerGlobal.SpawnPosX = 16398.768
		PlayerGlobal.SpawnPosY = -2957.145
		$Sounds/BirdChirp.stop()
		$Sounds/Cricket.stop()
		$Sounds/NightFrogs.stop()
		$Sounds/Cricket2.stop()
	...
	if $SpawnPoints/Spawn4.is_colliding():
		PlayerGlobal.SpawnPosX = 17811.912
		PlayerGlobal.SpawnPosY = -3539.81
		$Sounds/BirdChirp.stop()
		$Sounds/Cricket.stop()
		$Sounds/NightFrogs.stop()
		$Sounds/Cricket2.stop()
	...
	if $SpawnPoints/Spawn5.is_colliding():
		PlayerGlobal.SpawnPosX = 20146.967
		PlayerGlobal.SpawnPosY = -3898.735
		$Sounds/BirdChirp.stop()
		$Sounds/Cricket.stop()
		$Sounds/NightFrogs.stop()
		$Sounds/Cricket2.stop()
	...
	if $SpawnPoints/Spawn6.is_colliding():
		PlayerGlobal.SpawnPosX = 23017.275
		PlayerGlobal.SpawnPosY = -3361.104
		$Sounds/BirdChirp.stop()
		$Sounds/Cricket.stop()
		$Sounds/NightFrogs.stop()
		$Sounds/Cricket2.stop()

...
var currentlevel = "res://Levels/Begin/LevelBegin.tscn"
...
func _physics_process(delta):
	...
	if $PORTALS/PortalInLevel8/RayCast2D.is_colliding() and Input.is_action_just_pressed("Interact"):
		PlayerGlobal.SpawnPosX = 0
		PlayerGlobal.SpawnPosY = 0
	...
	elif PlayerGlobal.in_dialogue == true:
		Input.set_mouse_mode(Input.MOUSE_MODE_VISIBLE)
...
func _camera(delta):
	if PlayerGlobal.in_dialogue == true:
		...
		if DialogueStats.talking == "caen":
			$Hemwick/RemoteTransform2D.global_position =lerp($Hemwick/RemoteTransform2D.global_position,$NPCS/Caen.global_position, 5 * delta)
...
func _levelanimations():
	if $FrontSprites/Rails2/Rail4/RailControl/ControlChange.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_vehicle == false\
	and railanim_on == false and !$FrontSprites/Rails2/Rail4/RailAnim.current_animation == "Off":
			...
			railanim_on = true
	elif $FrontSprites/Rails2/Rail4/RailControl/ControlChange.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_vehicle == false\
	...
	if $FrontSprites/Rails2/RailControl2/ControlChange.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_vehicle == false\
	and railanim_on == false and !$FrontSprites/Rails2/Rail4/RailAnim.current_animation == "Off":
			$FrontSprites/Rails2/Rail4/RailAnim.play("On")
			railanim_on = true
	elif $FrontSprites/Rails2/RailControl2/ControlChange.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_vehicle == false\
	and railanim_on == true and !$FrontSprites/Rails2/Rail4/RailAnim.current_animation == "On" :
		$FrontSprites/Rails2/Rail4/RailAnim.play("Off")
		railanim_on = false
	...
	if $FrontSprites/Rails/RailControl/ControlChange.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_vehicle == false\
	...
	elif $FrontSprites/Rails/RailControl/ControlChange.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_vehicle == false\
...
func _tutorials():
	if $TutorialsRays/HarvestTutorial.is_colliding() and PlayerGlobal.harvesttut == false:
		$Tutorials.visible = true
		$Tutorials/Harvesting.visible = true
		$Tutorials/Harvesting/AnimationPlayer.play("Start")
		$TutorialsRays/HarvestTutorial.enabled = false
		$Hemwick/GUI.visible = false
		PlayerGlobal.harvesttut = true
		get_tree().paused = true

	elif $TutorialsRays/AttackingTutorial.is_colliding() and PlayerGlobal.attacktut == false:
		$Tutorials.visible = true
		$Tutorials/Attack.visible = true
		$Tutorials/Attack/AnimationPlayer.play("Start")
		$TutorialsRays/AttackingTutorial.enabled = false
		$Hemwick/GUI.visible = false
		PlayerGlobal.attacktut = true
		get_tree().paused = true

	elif $TutorialsRays/AirAttackTutorial.is_colliding() and PlayerGlobal.airattacktut == false:
		$Tutorials.visible = true
		...
		$Hemwick/GUI.visible = false
		PlayerGlobal.airattacktut = true
		get_tree().paused = true

	elif $TutorialsRays/InventoryTutorial.is_colliding() and PlayerGlobal.inventorytut == false:
		$Tutorials.visible = true
		...
		$Hemwick/GUI.visible = false
		PlayerGlobal.inventorytut = true
		get_tree().paused = true

	elif $TutorialsRays/DreadTutorial.is_colliding() and PlayerGlobal.dreadtut == false:
		$Tutorials.visible = true
		$Tutorials/Dread.visible = true
		$Tutorials/Dread/AnimationPlayer.play("Start")
		$TutorialsRays/DreadTutorial.enabled = false
		$Hemwick/GUI.visible = false
		PlayerGlobal.dreadtut = true
		get_tree().paused = true
...
func _dialogues():
	...
	if $LevelAreas/InnerDialAreas/Doesnotopen.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_dialogue == false:
	...
	if $LevelAreas/InnerDialAreas/YouShould.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_dialogue == false:
		var dialogue_resource = preload("res://Misc/Dialogues/Begin/Inner.tres")
		DialogueManager.show_example_dialogue_balloon( "YouShould", dialogue_resource)


	if $LevelAreas/InnerDialAreas/NoWayBackNow.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_dialogue == false:
	...
	if $LevelAreas/InnerDialAreas/Willy.is_colliding() and Input.is_action_just_pressed("Interact") and PlayerGlobal.in_dialogue == false and DialogueStats.willy == false:
...
func _spawnpoints():
	if $SpawnPoints/Spawn.is_colliding():
		PlayerGlobal.SpawnPosX = 4463.552
		PlayerGlobal.SpawnPosY = -822.788
